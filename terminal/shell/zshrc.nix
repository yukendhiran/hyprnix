{ config, lib, ... }: 
{
  xdg.configFile."/home/yukendhiran/.zshrc".text = ''
    export VISUAL='nvim'
      export EDITOR='nvim'
      ...
      export PATH="$PATH:/home/yukendhiran/.nix-profile/bin/elixir"
      export PATH="$PATH:/home/yukendhiran/.nix-profile/bin/swww"
      export PATH="$PATH:/home/yukendhiran/.nix-profile/bin/swww-daemon"
